export default {
  ...
  'setting.tab.ours': 'DMeta AI',
  'setting.label.serviceAddress': '服务地址',
  'setting.button.apply': '应用',
  'setting.text.introduction': '此前端交互软件是数元灵对Chat2DB二次开发，遵从开源项目规范，如有不妥，请联系我们。',
  ...
  'setting.placeholder.httpsProxy': '自研AI非必填，仅用于请求OPENAI接口时的HTTP代理{1}',
